...
def admin_page1_customizatio(parent):
        ...
        ctk.CTkLabel(parent,text="VitalDrop",font=("segoe UI", 40, "bold"),text_color="#c1121f").pack(pady=(20, 5))
        ...
        btn1 = ctk.CTkButton(custombtns, text="Add Donor", fg_color="#d62828", width=240, height=55, font=btn_font,command=open_add_donor)
